...
do
  ...
  --posterior-threshold ${MODELPTHRESH} \
...
aws s3 cp  ${DATADIR}/${FAMID}/results/${FAMID}_allchrs.denovos.all_mutations.tab ${DENOVOMODELFILTERDIR}/${FAMID}_allchrs.denovos.all_mutations.tab || die "Error uploading ${FAMID}_allchrs.denovos.all_mutations.tab "
aws s3 cp  ${DATADIR}/${FAMID}/results/${FAMID}_allchrs.denovos.locus_summary.tab ${DENOVOMODELFILTERDIR}/${FAMID}_allchrs.denovos.locus_summary.tab || die "Error uploading ${FAMID}_allchrs.denovos.locus_summary.tab "
...
awk  -v var=${MODELPTHRESH} -F "\t"  '{if($8>=var) print $0};' ${DATADIR}/${FAMID}/results/${FAMID}_allchrs.denovos.all_mutations.tab >> ${DATADIR}/${FAMID}/results/${FAMID}_allchrs.denovos.filtered_mutations.tab
aws s3 cp  ${DATADIR}/${FAMID}/results/${FAMID}_allchrs.denovos.filtered_mutations.tab ${DENOVOMODELFILTERDIR}/${FAMID}_allchrs.denovos.filtered_mutations.tab || die "Error uploading ${FAMID}_allchrs.denovos.filtered_mutations.tab "
